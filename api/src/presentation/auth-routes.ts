...
function signToken(user: { id: string | number; username: string; email: string; phone?: string; role: string; canEditAllQuotations?: boolean; fullName?: string; jobTitle?: string }): string {
